...
bash ./gcp_node-2_gpu/dataset-merge_tokenizer-JINIAC_v0_2_model-gpt_0.1113B/zero-0_dp-1_pp-1_tp-1_flashattn2-on.sh \
    --input_tokenizer_file /persistentshare/storage/team_nakamura/member/horie/tokenizer/JINIAC_V0_2.model \
    --output_model_dir /persistentshare/storage/team_nakamura/member/horie/output/step2_pretrain_model/merge2 \
    --save_interval 100
