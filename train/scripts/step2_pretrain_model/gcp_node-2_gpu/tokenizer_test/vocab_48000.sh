...
data_path="${megatron_deepspeed_dir}/dataset/merge3_48000_text_document"
...
#    mv ${megatron_deepspeed_dir}/dataset/arxiv_024de5df-1b7f-447c-8c3a-51407d8d6732.jsonl ${megatron_deepspeed_dir}/dataset/arxiv.jsonl
    python ${megatron_deepspeed_dir}/tools/preprocess_data.py \
        ...
        --input /persistentshare/storage/team_nakamura/member/horie/dataset/merged/merged.jsonl \
        --output-prefix ${megatron_deepspeed_dir}/dataset/merge3_48000 \
        --dataset-impl mmap \
...
template_json="${megatron_deepspeed_dir}/examples_deepspeed/rebase/ds_config_gpt_VOCABTEST.json"
