...
from preprocessing.download_dataset import c4, wikipedia, redpajama, redpajama_v2, lawdata_ja, aozora
...
def main():
    ...
    elif args.dataset == "aozora":
        aozora.download_dataset(output_base=args.output_base)
